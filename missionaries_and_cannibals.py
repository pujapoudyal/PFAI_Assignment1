...
class MissionariesAndCannibals:
    ...
    def mc(self):
        ...
        right_bank = self.state[2]     
        if boat == 'r':  
            if (right_bank[0] - 1 == 0 or right_bank[0] - 1 >= right_bank[1] + 1) and right_bank[0] >= 1 and left_bank[0] + 1 >= left_bank[1] + 1:
                right_bank[0] = right_bank[0] - 1
                right_bank[1] = right_bank[0] - 1
                boat = 'l'
            ...
            if  (left_bank[0] - 1 == 0 or left_bank[0] - 1 >= left_bank[1] + 1) and left_bank[0] >= 1 and right_bank[0] + 1 >= right_bank[1] + 1:
                left_bank[0] = left_bank[0] - 1
                left_bank[1] = left_bank[1] - 1
                boat = 'r'
                right_bank[0] = right_bank[0] + 1
    ...
    def c(self):
        ...
        right_bank = self.state[2]     
        if boat == 'r':  
            if (right_bank[0] == 0 or right_bank[0]  >= right_bank[1] + 1) and right_bank[1] >= 1:
            ...
            if (left_bank[0]  == 0 or left_bank[0]  >= left_bank[1] + 1) and left_bank[1] >= 1:
                left_bank[1] = left_bank[1] - 1
                boat = 'r'
                right_bank[1] = right_bank[1] + 1
                #update our state
